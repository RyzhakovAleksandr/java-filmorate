MERGE INTO mpa_rating (name) KEY (name) VALUES ('G');
MERGE INTO mpa_rating (name) KEY (name) VALUES ('PG');
MERGE INTO mpa_rating (name) KEY (name) VALUES ('PG-13');
MERGE INTO mpa_rating (name) KEY (name) VALUES ('R');
MERGE INTO mpa_rating (name) KEY (name) VALUES ('NC-17');
